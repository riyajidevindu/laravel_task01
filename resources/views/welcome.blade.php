                        ...
                        <div class="bg-gray-800 py-12">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div class="lg:text-center">
                                    <h2 class="text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl mb-4">
                        ...
                        <div class="bg-gray-800 py-12">
                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div class="mt-10 flex flex-wrap -mx-4 justify-center">
                                    ...
                                    <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                                        <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                                            <p class="text-gray-700 text-base mb-4">"Thanks to the foundation, I can pursue my passion for engineering without any hindrances. The support and mentorship are priceless."</p>
                                            <div class="flex items-center">
                                                <div class="w-12 h-12 rounded-full bg-gray-800"></div>
                                                <div class="ml-4">
                                                    <p class="text-gray-900 font-semibold">Jane Smith</p>
                                    ...
                                    <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                                        <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
                                            <p class="text-gray-700 text-base mb-4">"The Scholarship Foundation has not only supported me financially but has also guided me towards a brighter future. I am forever grateful."</p>
                                            <div class="flex items-center">
                                                <div class="w-12 h-12 rounded-full bg-gray-800"></div>
                                                <div class="ml-4">
                                                    <p class="text-gray-900 font-semibold">Samuel Green</p>
